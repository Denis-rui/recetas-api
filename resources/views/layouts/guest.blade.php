...
<head>
    ...
    <title>@yield('titulo', 'Acceso Administrativo') - ¿Qué Cocinamos?</title>
...
<body class="h-full antialiased font-sans text-slate-800 flex items-center justify-center p-4 sm:p-6 lg:p-8">
    <div class="w-full max-w-md space-y-6">
        <div class="text-center">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">¿Qué Cocinamos?</h1>
        ...
        <p class="text-center text-xs text-slate-500">
            &copy; {{ date('Y') }} ¿Qué Cocinamos? &bull; Acceso restringido para administradores.
        </p>
    </div>
</body>
</html>
